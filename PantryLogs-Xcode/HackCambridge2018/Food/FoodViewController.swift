...
class FoodViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
    ...
    func fetchFoods(website: String){
        let urlRequest = URLRequest(url: URL(string:"https://fierce-gorge-21914.herokuapp.com/obj")! )
        //put a string URL inside -- now: https://fierce-gorge-21914.herokuapp.com/obj --- real-time object list
